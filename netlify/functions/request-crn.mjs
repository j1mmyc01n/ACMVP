...
const COMBINED_AGREEMENT_VERSION = `terms-${LEGAL_VERSIONS.terms}-privacy-${LEGAL_VERSIONS.privacy}-medical-${LEGAL_VERSIONS.medical_disclaimer}`;
...
const pickClosestCentre = (centres, origin) => {
...
export default async (req, _context) => {
    ...
    try {
        ...
        const eligible = (centres || []).filter((c) => (c.active === undefined || c.active === null || c.active) &&
...
//# sourceMappingURL=request-crn.mjs.map