...
export default async (req, _context) => {
    ...
    const now = Date.now();
    const checkIns = [
        { crn: 'TST10000001', name: 'Test Patient Alpha', mood_score: 2, status: 'urgent', resolved: false, care_centre: TEST_CENTRE_NAME, created_at: new Date(now - 3600000).toISOString() },
        { crn: 'TST10000002', name: 'Test Patient Beta', mood_score: 5, status: 'pending', resolved: false, care_centre: TEST_CENTRE_NAME, created_at: new Date(now - 7200000).toISOString() },
        { crn: 'TST10000003', name: 'Test Patient Gamma', mood_score: 8, status: 'pending', resolved: false, care_centre: TEST_CENTRE_NAME, created_at: new Date(now - 10800000).toISOString() },
    ];
...
//# sourceMappingURL=seed-test-location.mjs.map