...
const DEFAULT_SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFtZmlrcG5jdGZnZXNpZndka2tkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDgwMDAwMDAsImV4cCI6MjAyMzYwMDAwMH0.placeholder';
/**
 ...
 */
export function isSupabaseHost(raw) {
...
const rawKey = typeof import.meta !== 'undefined'
    ? import.meta.env?.VITE_SUPABASE_ANON_KEY
    : process.env.VITE_SUPABASE_ANON_KEY;
export const SUPABASE_URL = isSupabaseHost(rawUrl)
    ? rawUrl.replace(/\/+$/, '')
...
if (rawUrl && !isSupabaseHost(rawUrl) && typeof console !== 'undefined') {
    console.warn(`[config] VITE_SUPABASE_URL ("${rawUrl}") is not a Supabase host; falling back to ${DEFAULT_SUPABASE_URL}`);
}
// ─── Netlify function base URL ────────────────────────────────────────────────
export const NETLIFY_FUNCTIONS_BASE = typeof import.meta !== 'undefined'
